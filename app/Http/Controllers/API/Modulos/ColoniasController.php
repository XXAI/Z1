...
class ColoniasController extends Controller
{
    public function index(Request $request)
    {
        try{
            ...
            if(!$access->is_admin){
                $objeto = $objeto->whereRaw("catalogo_localidad_id in (select id from catalogo_localidad where catalogo_municipio_id in ( select id from catalogo_municipio where catalogo_distrito_id in (".$access->distrito.")))");
            }
